...
> 최종 수정: 2026-08-03 · 구현 기준: `feature/pnm` 브랜치 (`Server/src/protocol.hpp`와 동일 내용)
>
...
| `LOGIN_OK` | `{"id":"user1","calib":{...}\|null,"calibs":{"1":{...},"2":null,…},"active_ch":1,"cam_ip":"192.168.0.31"\|null}` |
